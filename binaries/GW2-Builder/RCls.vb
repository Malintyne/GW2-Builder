...
#Region "Forms Load"
    ...
    Public Sub ResetImage()
        ...
        Mainfrm.ToolTip2.Location = Ai.Control.ToolTipLocation.Auto
    ...
    Public Sub Guardian()
        ...
        Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox40, "Virtue: Burn foes with every fifth attacks." & vbCrLf & "Activate: Grant Burning to you" _
                            & "and nearby allies next attack." & vbCrLf & "Burning (passive effect)(1s): 4 damage" & vbCrLf & "Burning (active effect)(5s): 4 damage")
        Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox41, "Virtue: Regenerate health." & vbCrLf & "Activate: Heal yourself and nearby allies." _
                            & vbCrLf & "Passive Renegeration: 3 seconds" & vbCrLf & "Healing: 25")
        Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox42, "Virtue: Grants Aegis every 40 seconds." & vbCrLf & "Activate: Grant Aegis to yourself and nearby allies." _
    ...
    Public Sub Elementalist()
        ...
        Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox40, "Attune to fire, gaining heavy damage and Burning abilities.")
        Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox41, "Attune to water, gaining superior support and healing abilities.")
        Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox42, "Attune to air, gaining heavy damage and control abilities.")
        Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox43, "Attune to earth, gaining superior damage over time and defensive abilities.")
    ...
    Public Sub Necromancer()
        ...
        Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox40, "Chain: Assume a spectral form and gain new skills, turning your life force into health." _
                                    & vbCrLf & "Skill Chain:" & vbCrLf & "Death Shroud > End Death Shroud")
        Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox41, "Chain: Leave Death Shroud and return to your normal form.")
    ...
    Public Sub CmbBox3()
        ...
        ElseIf Mainfrm.Label9.Text = "g" And Mainfrm.ComboBox3.Text = "Focus" Then
            ...
            Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox12, "Pass a ray over foes and allies. Foes are damaged and Blinded. Allies gain" _
                                & vbCrLf & "Regeneration and lose one condition." & vbCrLf & "Damage: 188" & vbCrLf & "Blindness(5s): Next outgoing attack misses" _
            ...
            Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox13, "Create a shield to Block the next 3 attacks. If the shield is not destroyed, it" _
                                & vbCrLf & "explodes, damaging nearby foes." & vbCrLf & "Damage: 1044" & vbCrLf & "Combo Finisher: Blast" & vbCrLf & "Range: 255")
        ElseIf Mainfrm.Label9.Text = "g" And Mainfrm.ComboBox3.Text = "Torch" Then
            ...
            Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox12, "Breathe magical flames than damages foes and remove condition" & vbCrLf & "from allies." _
            ...
            Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox34, "Chain. Throw your Zealot's Flame at the targeted foe, damaging them" _
                                & vbCrLf & "but increasing the skill's recharge time by 50%." & vbCrLf & "Damage: ???" & vbCrLf & "Range: 900")
        ElseIf Mainfrm.Label9.Text = "w" And Mainfrm.ComboBox3.Text = "Sword" Then
            ...
            Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox13, "Block the next incoming attack. Risposte and Bleed your foe if you block a melee" _
                                & vbCrLf & "attack. Gain adrenaline if your are not attacked." & vbCrLf & "Damage: 266" & vbCrLf & "Bleeding(12s): -2160 damage over time")
        ...
        ElseIf Mainfrm.Label9.Text = "en" And Mainfrm.ComboBox3.Text = "Shield" Then
            ...
            Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox12, "Create a magnetic field that Reflects projectiles and can be released to Push" _
                                & vbCrLf & "back foes." & vbCrLf & "Damage: 61" & vbCrLf & "Knockback: 300")
        ...
        ElseIf Mainfrm.Label9.Text = "t" And Mainfrm.ComboBox3.Text = "Dagger" Then
            ...
            ElseIf Mainfrm.ComboBox1.Text = "Dagger" Then
                ...
                Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox11, "Do an Evasive attack over your opponent, striking nearby enemies three times." _
                                            & vbCrLf & "Each hit causes Bleeding." & vbCrLf & "Damage: 444" & vbCrLf & "Bleeding(10s): -1,440 damage over time" _
                                            & vbCrLf & "Combo Finisher: Whirl")
...
#Region "Off Hand Set 2"
    Public Sub CmbBox4()
        ...
        ElseIf Mainfrm.Label9.Text = "g" And Mainfrm.ComboBox4.Text = "Torch" Then
            ...
            Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox26, "Breathe magical flames than damages foes and remove condition" & vbCrLf & "from allies." _
                                & vbCrLf & "Damage: 94" & vbCrLf & "Range: 300")
        ...
        ElseIf Mainfrm.Label9.Text = "t" And Mainfrm.ComboBox4.Text = "Dagger" Then
            ...
            ElseIf Mainfrm.ComboBox2.Text = "Dagger" Then
                ...
                Mainfrm.ToolTip2.SetToolTip(Mainfrm.PictureBox27, "Do an Evasive attack over your opponent, striking nearby enemies three times." _
                                            & vbCrLf & "Each hit causes Bleeding." & vbCrLf & "Damage: 444" & vbCrLf & "Bleeding(10s): -1,440 damage over time" _
                                            & vbCrLf & "Combo Finisher: Whirl")
...
#Region "Heal Skills"
    Public Sub Heal()
        ...
        ElseIf Mainfrm.Label9.Text = "g" Then
            ...
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox1, "Shelter")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox2, "Signet of Resolve")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox3, "Healing Breeze")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox1, "Block attack while healing." & vbCrLf & "Healing: 2485" & vbCrLf & "Block duration: 2 seconds")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox2, "Passive. Removes a condition every ten seconds." & vbCrLf & "Active. Heal yourself." _
                                          & vbCrLf & "Healing: 7225")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox3, "Heal your self and allies in a cone in front of you." & vbCrLf & "Self Heal: 7020" _
        ...
        ElseIf Mainfrm.Label9.Text = "w" Then
            ...
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox1, "Healing Surge")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox2, "Mending")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox3, "Healing Signet")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox1, "Heal yourself and build adrenaline." & vbCrLf & "Healing: 6620" & vbCrLf & "Block duration: 2 seconds")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox2, "Heal yourself and remove two conditions." & vbCrLf & "Healing: 5660")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox3, "Passive. Gain Regeneration." & vbCrLf & "Active. Heal yourself." & vbCrLf & "Healing: 7580")
            Selectfrm.ShowDialog()
        ElseIf Mainfrm.Label9.Text = "en" Then
            ...
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox1, "Elixir H")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox2, "Med Kit")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox3, "Healing Turret")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox1, "Drink Elixir H, healing yourself and randomly giving Protection, Regeneration or Swiftness." _
            ...
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox2, "Equip a kit that replaces your weapon with healing skills.")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox3, "Deploy a turret that heals you briefly, then continues to apply Regeneration to you and nearby allies.")
            Selectfrm.ShowDialog()
        ElseIf Mainfrm.Label9.Text = "r" Then
            Selectfrm.PictureBox1.Image = My.Resources.Elixir_H
            Selectfrm.PictureBox2.Image = My.Resources.Med_Kit
            Selectfrm.PictureBox3.Image = My.Resources.Healing_Turret
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox1, "Heal as One")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox2, "Healing Spring")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox3, "Troll Unguent")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox1, "Heal yourself and your pet." & vbCrLf & "Healing: 6620")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox2, "Create a healing spring that heals you and your pet. Once placed, the spring applies" _
            ...
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox3, "You and your pet regenerate health over time." & vbCrLf & "Health per second: 868" _
        ...
        ElseIf Mainfrm.Label9.Text = "t" Then
            ...
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox1, "Hide in Shadows")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox2, "Withdraw")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox3, "Signet of Malice")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox1, "Vanish in Stealth and gain Regeneration." & vbCrLf & "Healing: 0" _
                                           & vbCrLf & "Regen(4s): +312 health regen" & vbCrLf & "Stealth Duration: 3 seconds")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox2, "Roll backward while healing and Evade attacks." & vbCrLf & "Healing: 160")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox3, "Passive. Grants health when you attack." & vbCrLf & "Active. Gain health." _
                                           & vbCrLf & "Healing: 200")
            Selectfrm.ShowDialog()
        ElseIf Mainfrm.Label9.Text = "el" Then
            ...
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox1, "Glyph of Elemental Harmony")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox2, "Ether Renewal")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox3, "Signet of Restoration")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox1, "Heal yourself and gain a boon based on your attunement." & vbCrLf & "Fire. Gain might." _
            ...
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox2, "Heal yourself and lose a condition with every pulse." & vbCrLf & "Healing: 420")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox3, "Passive. Grants health every time you cast a spell." & vbCrLf & "Active. Heal yourself." _
                                           & vbCrLf & "Air. Gain swiftness." & vbCrLf & "Water. Gain regeneration." & vbCrLf & "Earth. Gain protection." _
                                           & vbCrLf & "Healing: 6630")
            Selectfrm.ShowDialog()
        ElseIf Mainfrm.Label9.Text = "m" Then
            ...
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox1, "Ether Feast")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox2, "Mirror")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox3, "Mantra of Recovery")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox1, "Heal yourself. Gain additional health for each active illusion." & vbCrLf & "Healing: 5660" _
                                           & vbCrLf & "Heal per illusion: 2232")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox2, "Reflect incoming projectiles and heal yourself." & vbCrLf & "Healing: 220")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox3, "Meditate to charge a spell that will instantly heal you when activated.")
            Selectfrm.ShowDialog()
        ElseIf Mainfrm.Label9.Text = "n" Then
            ...
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox1, "Summon Blood Fiend")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox2, "Consume Conditions")
            Selectfrm.ToolTip1.SetToolTipTitle(Selectfrm.PictureBox3, "Well of Blood")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox1, "Summon a blood fiend that transfers health to you on each attack." & vbCrLf & "Healing: 30")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox2, "Feast on your conditions, gaining health for each one consumed." & vbCrLf & "Healing: 120" _
                                           & vbCrLf & "Heal per conditions: 20")
            Selectfrm.ToolTip1.SetToolTip(Selectfrm.PictureBox3, "Conjure a well of blood to heal nearby allies." & vbCrLf & "Initial Self Heal: 120" _
